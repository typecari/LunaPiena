...
const TRANSLATIONS = {
  ...
  en: {
    ...
    // Guest Portal
    gp_welcome_eyebrow:     "Welcome to Luna Piena",
    gp_checkin_label:        "Check-in",
    gp_checkout_label:       "Check-out",
    gp_room_label:           "Room",
    gp_your_guide:           "Your Guide",
    gp_nav_room:             "Your Room",
    gp_nav_wifi:             "Wi-Fi",
    gp_nav_tv:               "TV",
    gp_nav_smarthome:        "Smart Home",
    gp_nav_bathroom:         "Bathroom",
    gp_nav_menu:             "Menu & Drinks",
    gp_nav_safety:           "Safety",
    gp_nav_checkout:         "Before You Leave",
    gp_mnav_room:            "Room",
    gp_mnav_bath:            "Bath",
    gp_mnav_menu:            "Menu",
    gp_mnav_safety:          "Safety",
    gp_mnav_leave:           "Leave",
    gp_room_tag:             "Your Space",
    gp_room_title:           "Your Room",
    gp_room_lead:            "Your comfort is our priority. Here's what you'll find:",
    gp_room_1:               "The comfiest mattress in the world",
    gp_room_2:               "Full 400 Thread Count Performance Sheet Set, with more than 4 pillow options",
    gp_room_3:               "Fresh towels are placed on the bed",
    gp_room_4:               "Extra blankets are in the closet",
    gp_room_5:               "Outlets are available on both sides of the bed",
    gp_room_6:               "Please let us know ahead of time if you prefer the AC to be lower",
    gp_room_7:               "Feel free to adjust blinds & lighting to your preference",
    gp_wifi_tag:             "Connectivity",
    gp_wifi_title:           "Wi-Fi Access",
    gp_wifi_lead:            "Connect easily by scanning the QR code in your guestroom.",
    gp_tv_tag:               "Entertainment",
    gp_tv_title:             "TV & Entertainment",
    gp_tv_lead:              "Enjoy your favorite shows and movies:",
    gp_tv_1:                 "Netflix, Disney+, and Prime Video are available",
    gp_tv_2:                 "Turn on the TV and select the Guest Profile",
    gp_tv_3:                 "Feel free to log into your personal accounts if needed",
    gp_lucy_tag:             "Resident Companion",
    gp_lucy_title:           "Greetings from Lucy",
    gp_lucy_lead:            "Lucy is our friendly and curious companion",
    gp_lucy_1:               "She's very friendly and loves hanging out with people. Give her cariñitos and she may stay with you all day.",
    gp_lucy_important:       "Important:",
    gp_lucy_food:            "Please do not feed Lucy any* human food. She has special dietary needs.",
    gp_lucy_cheese:          "*unless it's parmesan cheese. She says that's okay.",
    gp_smart_tag:            "Voice Control",
    gp_smart_title:          "Smart Home Assistance",
    gp_smart_lead:           "Use voice commands to control your environment:",
    gp_smart_music:          "Music",
    gp_smart_environment:    "Environment",
    gp_bath_tag:             "Bathroom",
    gp_bath_title:           "Bathroom",
    gp_bath_1:               "Towels are yours to use freely during your stay",
    gp_bath_2:               "Place used towels once a week in the laundry room",
    gp_bath_3:               "Hair dryer is in the bottom drawer on the left",
    gp_bath_4:               "Toiletries provided: face wash, body wash and a 2-in-1 shampoo/conditioner. If you have any sensitivity please let us know.",
    gp_bath_5:               "Forgot your toothbrush or need a moisturizer? Just let us know — we got you!",
    gp_bath_6:               "No toilet paper? Say \"Hey Google, broadcast: I need toilet paper.\" If we're in a meeting, send a WhatsApp instead. (Please and thank you!)",
    gp_menu_tag:             "Food & Drinks",
    gp_menu_title:           "Menu & Drinks",
    gp_menu_lead:            "Experience the best of Setaro's cuisine.",
    gp_menu_note:            "To enjoy our special menu, please simply let us know by the evening prior.",
    gp_safety_tag:           "Safety",
    gp_safety_title:         "Safety & Emergency",
    gp_safety_lead:          "Your safety is important to us. Please note the following:",
    gp_safety_emergency:     "Emergency",
    gp_safety_firstaid:      "First-Aid Kit",
    gp_safety_firstaid_loc:  "Hallway closet",
    gp_safety_address:       "Address",
    gp_safety_address_info:  "Available on your booking confirmation",
    gp_checkout_tag:         "Before You Go",
    gp_checkout_title:       "Before You Leave",
    gp_checkout_lead:        "To help us prepare for the next guest, please:",
    gp_check_1:              "Place used towels in the laundry room",
    gp_check_2:              "Double-check for all your belongings",
    gp_check_3:              "Let us know your checkout time the night before",
    gp_check_4:              "📸 Don't forget our selfie with the Fujifilm camera — you've made it to the Hall of Fame wall!",
    gp_footer_thanks:        "Thank you for staying with us. We hope your experience is unforgettable.",
  },
  ...
  es: {
    ...
    hero_tagline:           "LUNA PIENA del Lupo Group",
    ...
    featured_excerpt:       "En un mundo que se mueve cada vez más rápido, tomarla suave se ha convertido en una necesidad. En Luna Piena, hemos construido nuestra filosofía alrededor de esta idea.",
    ...
    menu_request_note:      "Todos los platos se preparan frescos bajo pedido. Infórmanos tus preferencias y restricciones dietéticas al reservar.",
    menu_price_label:       "por persona",
    menu_available_note:    "La disponibilidad estacional puede variar.",


    // Booking page
    booking_title:          "Comienza Tu Experiencia en Luna Piena",
    ...
    // Guest Portal
    gp_welcome_eyebrow:     "Bienvenidos a Luna Piena",
    gp_checkin_label:        "Llegada",
    gp_checkout_label:       "Salida",
    gp_room_label:           "Habitación",
    gp_your_guide:           "Tu Guía",
    gp_nav_room:             "Tu Habitación",
    gp_nav_wifi:             "Wi-Fi",
    gp_nav_tv:               "TV",
    gp_nav_smarthome:        "Smart Home",
    gp_nav_bathroom:         "Baño",
    gp_nav_menu:             "Menú y Bebidas",
    gp_nav_safety:           "Seguridad",
    gp_nav_checkout:         "Antes de Irte",
    gp_mnav_room:            "Hab.",
    gp_mnav_bath:            "Baño",
    gp_mnav_menu:            "Menú",
    gp_mnav_safety:          "Seguridad",
    gp_mnav_leave:           "Salida",
    gp_room_tag:             "Tu Espacio",
    gp_room_title:           "Tu Habitación",
    gp_room_lead:            "Tu comodidad es nuestra prioridad. Esto es lo que encontrarás:",
    gp_room_1:               "El colchón más cómodo del mundo",
    gp_room_2:               "Juego de sábanas de 400 hilos, con más de 4 opciones de almohada",
    gp_room_3:               "Toallas recien lavaditas encima de la cama",
    gp_room_4:               "Las cobijas extra están en el clóset",
    gp_room_5:               "Hay enchufes disponibles en ambos lados de la cama",
    gp_room_6:               "Por favor avísanos con anticipación si prefieres el AC más bajo",
    gp_room_7:               "Siéntete libre de ajustar las persianas e iluminación a tu gusto",
    gp_wifi_tag:             "Conectividad",
    gp_wifi_title:           "Acceso Wi-Fi",
    gp_wifi_lead:            "Conéctate fácilmente escaneando el código QR en tu habitación.",
    gp_tv_tag:               "Entretenimiento",
    gp_tv_title:             "TV y Entretenimiento",
    gp_tv_lead:              "Disfruta tus programas y películas favoritas:",
    gp_tv_1:                 "Netflix, Disney+ y Prime Video están disponibles",
    gp_tv_2:                 "Enciende el TV y selecciona el Perfil de Invitado",
    gp_tv_3:                 "Siéntete libre de iniciar sesión en tus cuentas personales si lo necesitas",
    gp_lucy_tag:             "Compañera de piso",
    gp_lucy_title:           "Un saludo de parte de Lucy",
    gp_lucy_lead:            "Lucy es nuestra compañera amigable y curiosa",
    gp_lucy_1:               "Es muy amigable y le encanta pasar el rato con la gente. Dale cariñitos y puede que se quede contigo todo el día.",
    gp_lucy_important:       "Importante:",
    gp_lucy_food:            "Por favor no le des a Lucy comida humana*. Tiene una dieta especial.",
    gp_lucy_cheese:          "*a menos que sea queso parmesano. Ella no te dirá que no.",
    gp_smart_tag:            "Control por Voz",
    gp_smart_title:          "Asistente de Hogar Inteligente",
    gp_smart_lead:           "Usa comandos de voz para controlar tu entorno:",
    gp_smart_music:          "Música",
    gp_smart_environment:    "Ambiente",
    gp_bath_tag:             "Baño",
    gp_bath_title:           "Baño",
    gp_bath_1:               "Las toallas son tuyas para usar libremente durante tu estadía",
    gp_bath_2:               "Coloca las toallas usadas una vez a la semana en el cuarto de lavado",
    gp_bath_3:               "El secador de pelo está en el cajón inferior izquierdo",
    gp_bath_4:               "Artículos de tocador incluidos: jabón facial, jabón corporal y un 2-en-1 shampoo/acondicionador. Si tienes alguna sensibilidad, avísanos.",
    gp_bath_5:               "¿Olvidaste tu cepillo de dientes o necesitas crema hidratante? Solo avísanos — ¡Se te tiene!",
    gp_bath_6:               "¿Se acabó el papel higiénico? Di \"Hey Google, anuncia: necesito papel higiénico.\" Ojo, si estamos en reunión, mejor envíannos un mensaje por WhatsApp. (¡Por favor y gracias!)",
    gp_menu_tag:             "Comida y Bebidas",
    gp_menu_title:           "Menú y Bebidas",
    gp_menu_lead:            "Disfruta lo mejor de la cocina de Setaro.",
    gp_menu_note:            "Para disfrutar de nuestro menú especial, simplemente avísanos la noche anterior.",
    gp_safety_tag:           "Seguridad",
    gp_safety_title:         "Seguridad y Emergencia",
    gp_safety_lead:          "Tu seguridad es importante para nosotros. Ten en cuenta lo siguiente:",
    gp_safety_emergency:     "Emergencia",
    gp_safety_firstaid:      "Botiquín",
    gp_safety_firstaid_loc:  "Closet del pasillo",
    gp_safety_address:       "Dirección",
    gp_safety_address_info:  "Disponible en tu confirmación de reserva",
    gp_checkout_tag:         "Antes de Partir",
    gp_checkout_title:       "Antes de Partir",
    gp_checkout_lead:        "Para ayudarnos a prepararnos para el próximo huésped, por favor:",
    gp_check_1:              "Coloca las toallas usadas en el cuarto de lavado",
    gp_check_2:              "Verifica que tengas todas tus pertenencias",
    gp_check_3:              "Avísanos tu hora de salida la noche anterior",
    gp_check_4:              "📸 ¡No olvides nuestra selfie con la cámara Fujifilm —  para actualizar el Muro de la Fama!",
    gp_footer_thanks:        "Gracias por quedarte con nosotros. Esperamos que tu experiencia sea inolvidable.",
  },
