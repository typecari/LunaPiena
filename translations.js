...
const TRANSLATIONS = {
  ...
  es: {
    ...
    gp_room_3:               "Toallas frescas están colocadas en la cama",
    gp_room_4:               "Cobijas extra están en el closet",
    ...
    gp_tv_2:                 "Enciende la TV y selecciona el Perfil de Invitado",
    gp_tv_3:                 "Siéntete libre de iniciar sesión en tus cuentas personales si lo necesitas",
    gp_lucy_tag:             "Compañera Residente",
    gp_lucy_title:           "Saludos de Lucy",
    ...
    gp_lucy_food:            "Por favor no le des a Lucy comida humana*. Tiene necesidades dietéticas especiales.",
    gp_lucy_cheese:          "*a menos que sea queso parmesano. Ella dice que eso sí está bien.",
    ...
    gp_bath_4:               "Artículos de tocador incluidos: jabón facial, jabón corporal y un 2-en-1 champú/acondicionador. Si tienes alguna sensibilidad avísanos.",
    gp_bath_5:               "¿Olvidaste tu cepillo de dientes o necesitas crema hidratante? Solo avísanos — ¡te tenemos!",
    gp_bath_6:               "¿Sin papel higiénico? Di \"Hey Google, broadcast: necesito papel higiénico.\" Si estamos en reunión, envía un WhatsApp. (¡Por favor y gracias!)",
    ...
    gp_checkout_tag:         "Antes de Irte",
    gp_checkout_title:       "Antes de Irte",
    gp_checkout_lead:        "Para ayudarnos a preparar para el próximo huésped, por favor:",
    ...
    gp_check_4:              "📸 ¡No olvides nuestra selfie con la cámara Fujifilm — llegaste al Muro de la Fama!",
